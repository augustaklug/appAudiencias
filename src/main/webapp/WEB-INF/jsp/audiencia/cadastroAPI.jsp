									...
									<div class="col-lg-6 col-sm-6">
										...
										<div class="mb-3">
											...
											<div class="input-group">
												...
												<input type="text" class="form-control" id="autos" name="processo" value="${processoAPI}" readonly>
											</div>
										</div>
										<!-- End of Form -->
										<div class="mb-3">
											...
											<div class="input-group">
												...
												<input class="form-control" id="data" name="data" type="date" value="${dataAPI}" required readonly>
											</div>
										</div>
									...
									<div class="col-lg-6 col-sm-6">
										...
										<div class="mb-3">
											...
											<div class="input-group">
												...
												<input class="form-control" id="hora" name="hora" type="time" value="${horaAPI}" required readonly>
											</div>
										</div>
									</div>
