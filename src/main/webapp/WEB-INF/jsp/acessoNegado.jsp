    ...
    <div class="container">
      <div class="row">
        <div class="col-12 text-center d-flex align-items-center justify-content-center">
          <div>
            <h1 class="mt-5">Acesso <span class="font-weight-bolder text-primary">negado</span></h1>
            <p class="lead my-4">Você não tem permissão para acessar essa página.</p>
            <a class="btn btn-primary animate-hover" href="/"><i class="fas fa-chevron-left mr-3 pl-2 animate-left-3"></i>Voltar para a home</a>
          </div>
        </div>
      </div>
    </div>
